...
public class MinecraftMath {
  public Vector3d calculateIntercept(AABB area, Vector3d pos, Vector3d ray) {
  ...
  public Vector3d getLookVector(double yaw, double pitch) {
